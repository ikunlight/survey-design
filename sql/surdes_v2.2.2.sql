...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'DESKTOP-NONF7P61714918435277', 1714921743502, 15000);
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', NULL, 1714918440000, -1, 5, 'PAUSED', 'CRON', 1714918435000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', NULL, 1714918440000, -1, 5, 'PAUSED', 'CRON', 1714918435000, 0, NULL, 2, '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', NULL, 1714918440000, -1, 5, 'PAUSED', 'CRON', 1714918435000, 0, NULL, 2, '');
...
INSERT INTO `sys_logininfor` VALUES (11, 'admin', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '1', '用户不存在/密码错误', '2024-04-26 10:40:39');
INSERT INTO `sys_logininfor` VALUES (12, 'admin', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '1', '用户不存在/密码错误', '2024-04-26 10:40:50');
INSERT INTO `sys_logininfor` VALUES (13, 'admin', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '0', '登录成功', '2024-04-26 10:41:19');
INSERT INTO `sys_logininfor` VALUES (14, 'admin', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '1', '验证码已失效', '2024-05-05 22:16:31');
INSERT INTO `sys_logininfor` VALUES (15, 'admin', '127.0.0.1', '内网IP', 'Chrome 12', 'Windows 10', '0', '登录成功', '2024-05-05 22:16:35');
...
INSERT INTO `sys_oper_log` VALUES (91, '问卷撤销发布', 3, 'com.shure.surdes.survey.controller.SurveyController.revoke()', 'PUT', 1, 'admin', NULL, '/survey/survey/revoke/2', '127.0.0.1', '内网IP', '2', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-04-26 11:23:52');
INSERT INTO `sys_oper_log` VALUES (92, '问卷新增', 1, 'com.shure.surdes.survey.controller.SurveyController.add()', 'POST', 1, 'admin', NULL, '/survey/survey', '127.0.0.1', '内网IP', '{\"surveyId\":3,\"params\":{},\"userId\":1,\"surveyName\":\"3333\",\"createTime\":1714918613058,\"status\":\"1\"}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 22:16:53');
INSERT INTO `sys_oper_log` VALUES (93, '问卷题目', 1, 'com.shure.surdes.survey.controller.QuestionController.add()', 'POST', 1, 'admin', NULL, '/survey/question', '127.0.0.1', '内网IP', '{\"surveyId\":3,\"questionId\":21,\"notEdit\":\"0\",\"showOrHide\":\"0\",\"questionName\":\"详细受说\",\"params\":{},\"answer\":{\"params\":{}},\"createTime\":1714918629654,\"options\":[],\"questionType\":\"table\",\"optionDisplay\":\"column\"}', '{\"msg\":\"操作成功\",\"code\":200,\"data\":{\"answer\":{\"params\":{}},\"createTime\":1714918629654,\"notEdit\":\"0\",\"optionDisplay\":\"column\",\"options\":[],\"params\":{},\"questionId\":21,\"questionName\":\"详细受说\",\"questionType\":\"table\",\"showOrHide\":\"0\",\"surveyId\":3}}', 0, NULL, '2024-05-05 22:17:09');
INSERT INTO `sys_oper_log` VALUES (94, '更新问题序号和排序', 2, 'com.shure.surdes.survey.controller.QuestionController.updateQueNo()', 'PUT', 1, 'admin', NULL, '/survey/question/updateQueNo', '127.0.0.1', '内网IP', '[{\"questionId\":21,\"questionNo\":1,\"questionSort\":1}]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 22:17:10');
INSERT INTO `sys_oper_log` VALUES (95, '问卷题目', 1, 'com.shure.surdes.survey.controller.QuestionController.add()', 'POST', 1, 'admin', NULL, '/survey/question', '127.0.0.1', '内网IP', '{\"surveyId\":3,\"questionId\":22,\"notEdit\":\"0\",\"showOrHide\":\"0\",\"questionName\":\"1+1=\",\"params\":{},\"answer\":{\"params\":{}},\"createTime\":1714918644546,\"options\":[],\"questionType\":\"compute\",\"optionDisplay\":\"column\"}', '{\"msg\":\"操作成功\",\"code\":200,\"data\":{\"answer\":{\"params\":{}},\"createTime\":1714918644546,\"notEdit\":\"0\",\"optionDisplay\":\"column\",\"options\":[],\"params\":{},\"questionId\":22,\"questionName\":\"1+1=\",\"questionType\":\"compute\",\"showOrHide\":\"0\",\"surveyId\":3}}', 0, NULL, '2024-05-05 22:17:24');
INSERT INTO `sys_oper_log` VALUES (96, '更新问题序号和排序', 2, 'com.shure.surdes.survey.controller.QuestionController.updateQueNo()', 'PUT', 1, 'admin', NULL, '/survey/question/updateQueNo', '127.0.0.1', '内网IP', '[{\"questionId\":21,\"questionNo\":1,\"questionSort\":1},{\"questionId\":22,\"questionNo\":2,\"questionSort\":2}]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 22:17:24');
INSERT INTO `sys_oper_log` VALUES (97, '更新问题序号和排序', 2, 'com.shure.surdes.survey.controller.QuestionController.updateQueNo()', 'PUT', 1, 'admin', NULL, '/survey/question/updateQueNo', '127.0.0.1', '内网IP', '[{\"questionId\":21,\"questionNo\":1,\"questionSort\":1},{\"questionId\":22,\"questionNo\":2,\"questionSort\":2}]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 22:18:58');
INSERT INTO `sys_oper_log` VALUES (98, '问卷题目', 3, 'com.shure.surdes.survey.controller.QuestionController.remove()', 'DELETE', 1, 'admin', NULL, '/survey/question/21', '127.0.0.1', '内网IP', '{questionIds=21}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 22:19:00');
INSERT INTO `sys_oper_log` VALUES (99, '更新问题序号和排序', 2, 'com.shure.surdes.survey.controller.QuestionController.updateQueNo()', 'PUT', 1, 'admin', NULL, '/survey/question/updateQueNo', '127.0.0.1', '内网IP', '[{\"questionId\":22,\"questionNo\":1,\"questionSort\":1}]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 22:19:00');
INSERT INTO `sys_oper_log` VALUES (100, '更新问题序号和排序', 2, 'com.shure.surdes.survey.controller.QuestionController.updateQueNo()', 'PUT', 1, 'admin', NULL, '/survey/question/updateQueNo', '127.0.0.1', '内网IP', '[{\"questionId\":22,\"questionNo\":1,\"questionSort\":1}]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 22:19:34');
INSERT INTO `sys_oper_log` VALUES (101, '问卷题目', 3, 'com.shure.surdes.survey.controller.QuestionController.remove()', 'DELETE', 1, 'admin', NULL, '/survey/question/22', '127.0.0.1', '内网IP', '{questionIds=22}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 22:19:35');
INSERT INTO `sys_oper_log` VALUES (102, '问卷题目', 1, 'com.shure.surdes.survey.controller.QuestionController.add()', 'POST', 1, 'admin', NULL, '/survey/question', '127.0.0.1', '内网IP', '{\"surveyId\":3,\"questionId\":23,\"validateRule\":\"notEmpty\",\"defaultValue\":\"111\",\"notEdit\":\"0\",\"showOrHide\":\"0\",\"questionName\":\"\",\"params\":{},\"answer\":{\"params\":{}},\"createTime\":1714918795094,\"options\":[],\"questionType\":\"file\",\"optionDisplay\":\"column\"}', '{\"msg\":\"操作成功\",\"code\":200,\"data\":{\"answer\":{\"params\":{}},\"createTime\":1714918795094,\"defaultValue\":\"111\",\"notEdit\":\"0\",\"optionDisplay\":\"column\",\"options\":[],\"params\":{},\"questionId\":23,\"questionName\":\"\",\"questionType\":\"file\",\"showOrHide\":\"0\",\"surveyId\":3,\"validateRule\":\"notEmpty\"}}', 0, NULL, '2024-05-05 22:19:55');
INSERT INTO `sys_oper_log` VALUES (103, '更新问题序号和排序', 2, 'com.shure.surdes.survey.controller.QuestionController.updateQueNo()', 'PUT', 1, 'admin', NULL, '/survey/question/updateQueNo', '127.0.0.1', '内网IP', '[{\"questionId\":23,\"questionNo\":1,\"questionSort\":1}]', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 22:19:55');
INSERT INTO `sys_oper_log` VALUES (104, '问卷题目', 3, 'com.shure.surdes.survey.controller.QuestionController.remove()', 'DELETE', 1, 'admin', NULL, '/survey/question/23', '127.0.0.1', '内网IP', '{questionIds=23}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 22:19:59');
INSERT INTO `sys_oper_log` VALUES (105, '字典类型', 3, 'com.shure.surdes.web.controller.system.SysDictDataController.remove()', 'DELETE', 1, 'admin', NULL, '/system/dict/data/41', '127.0.0.1', '内网IP', '{dictCodes=41}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 23:04:15');
INSERT INTO `sys_oper_log` VALUES (106, '字典类型', 3, 'com.shure.surdes.web.controller.system.SysDictDataController.remove()', 'DELETE', 1, 'admin', NULL, '/system/dict/data/42', '127.0.0.1', '内网IP', '{dictCodes=42}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 23:04:19');
INSERT INTO `sys_oper_log` VALUES (107, '字典类型', 3, 'com.shure.surdes.web.controller.system.SysDictDataController.remove()', 'DELETE', 1, 'admin', NULL, '/system/dict/data/43', '127.0.0.1', '内网IP', '{dictCodes=43}', '{\"msg\":\"操作成功\",\"code\":200}', 0, NULL, '2024-05-05 23:04:22');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', '2024-05-05 22:16:36', 'admin', '2024-03-12 22:37:06', '', '2024-05-05 22:16:35', '管理员');
...
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '问卷题目表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '问卷表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of tb_survey
-- ----------------------------
INSERT INTO `tb_survey` VALUES (1, '1111', '111', '01', '0', '2024-03-13 20:53:20', 1, '1', '');
INSERT INTO `tb_survey` VALUES (2, '2222', NULL, NULL, '0', '2024-03-17 20:34:25', 1, '1', '');
INSERT INTO `tb_survey` VALUES (3, '3333', NULL, NULL, '0', '2024-05-05 22:16:53', 1, '1', '');
